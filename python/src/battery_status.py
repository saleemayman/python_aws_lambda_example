...
def lambda_handler(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    try:
        ...
        logging.error(log("Error parsing and processing input", error=e))
        response = {
            "statusCode": 400,
            "body": json.dumps({"error": "Error parsing input", "details": e}),
        }
    except Exception as e:
        response = {
            "statusCode": 500,
            "body": json.dumps({"error": "Unexpected server error", "details": e}),
        }
...
#     test_inputs = [
#         {"body": '{"device": "device_1", "payload": "F1E6E63676C75000"}'},
#         {"body": '{"device": "device_2", "payload": "9164293726C85400"}'},
#         {"body": '{"device": "device_3", "payload": "6188293726C75C00"}'},
#     ]
